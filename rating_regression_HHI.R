...
## HHI ~ vol_tot  AAA## 
model.2 <- lmList(HHI ~ vol_tot | cusip_id, data = subAAA)
...
## HHI ~ vol_tot  AA## 
model.3 <- lmList(HHI ~ vol_tot | cusip_id, data = subAA)
...
ggplot(data = model.3.data, aes(x = coef.vol_tot, y = dnorm)) +
  geom_point()
## HHI ~ vol_tot  A## 
model.4 <- lmList(HHI ~ vol_tot | cusip_id, data = subA)
...
## HHI~p_avg+log(vol_tot) AAA##
model.5 <- lmList(HHI ~ log(vol_tot) + p_avg | cusip_id, data = subAAA)
...
## HHI~p_avg+log(vol_tot) AA##
model.6 <- lmList(HHI ~ log(vol_tot) + p_avg | cusip_id, data = subAA)
...
ggplot(data = model.6.data, aes(x = coef.vol_tot, y = dnorm)) +
  geom_point()
## HHI~p_avg+log(vol_tot) A##
model.7 <- lmList(HHI ~ log(vol_tot) + p_avg | cusip_id, data = subA)
...
ggplot(data = model.7.data, aes(x = coef.vol_tot, y = dnorm)) +
  geom_point()
## HHI~p_avg+log(vol_tot) BBB##
model.8 <- lmList(HHI ~ log(vol_tot) + p_avg | cusip_id, data = subBBB)
...
ggplot(data = model.8.data, aes(x = coef.vol_tot, y = dnorm)) +
  geom_point()
## HHI~p_avg+log(vol_tot) BB##
model.9 <- lmList(HHI ~ log(vol_tot) + p_avg | cusip_id, data = subBB)
...
ggplot(data = model.9.data, aes(x = coef.vol_tot, y = dnorm)) +
  geom_point()
## HHI~p_avg+log(vol_tot) B##
model.10 <- lmList(HHI ~ log(vol_tot) + p_avg | cusip_id, data = subB)
...
ggplot(data = model.10.data, aes(x = coef.vol_tot, y = dnorm)) +
  geom_point()
## HHI~p_avg+log(vol_tot) CCC##
model.11 <- lmList(HHI ~ log(vol_tot) + p_avg | cusip_id, data = subCCC)
...
ggplot(data = model.11.data, aes(x = coef.vol_tot, y = dnorm)) +
  geom_point()
## HHI~p_avg+log(vol_tot) CC##
model.12 <- lmList(HHI ~ log(vol_tot) + p_avg | cusip_id, data = subCC)
...
ggplot(data = model.12.data, aes(x = coef.vol_tot, y = dnorm)) +
  geom_point()
## HHI~p_avg+log(vol_tot) C##
model.13 <- lmList(HHI ~ log(vol_tot) + p_avg | cusip_id, data = subC)
...
## HHI~p_avg+sqrt(vol_tot) AAA##
model.14 <- lmList(HHI ~ sqrt(vol_tot) + p_avg | cusip_id, data = subAAA)
...
## HHI~p_avg+sqrt(vol_tot) AA##
model.15 <- lmList(HHI ~ sqrt(vol_tot) + p_avg | cusip_id, data = subAA)
...
ggplot(data = model.15.data, aes(x = coef.vol_tot, y = dnorm)) +
  geom_point()
## HHI~p_avg+sqrt(vol_tot) A##
model.16 <- lmList(HHI ~ sqrt(vol_tot) + p_avg | cusip_id, data = subA)
...
ggplot(data = model.16.data, aes(x = coef.vol_tot, y = dnorm)) +
  geom_point()
## HHI~p_avg+sqrt(vol_tot) BBB##
model.17 <- lmList(HHI ~ sqrt(vol_tot) + p_avg | cusip_id, data = subBBB)
...
ggplot(data = model.17.data, aes(x = coef.vol_tot, y = dnorm)) +
  geom_point()
## HHI~p_avg+sqrt(vol_tot) BB##
model.18 <- lmList(HHI ~ sqrt(vol_tot) + p_avg | cusip_id, data = subBB)
...
ggplot(data = model.18.data, aes(x = coef.vol_tot, y = dnorm)) +
  geom_point()
## HHI~p_avg+sqrt(vol_tot) B##
model.19 <- lmList(HHI ~ sqrt(vol_tot) + p_avg | cusip_id, data = subB)
...
ggplot(data = model.19.data, aes(x = coef.vol_tot, y = dnorm)) +
  geom_point()
## HHI~p_avg+sqrt(vol_tot) CCC##
model.20 <- lmList(HHI ~ sqrt(vol_tot) + p_avg | cusip_id, data = subCCC)
...
ggplot(data = model.20.data, aes(x = coef.vol_tot, y = dnorm)) +
  geom_point()
## HHI~p_avg+sqrt(vol_tot) CC##
model.21 <- lmList(HHI ~ sqrt(vol_tot) + p_avg | cusip_id, data = subCC)
...
ggplot(data = model.21.data, aes(x = coef.vol_tot, y = dnorm)) +
  geom_point()
## HHI~p_avg+sqrt(vol_tot) C##
model.22 <- lmList(HHI ~ sqrt(vol_tot) + p_avg | cusip_id, data = subC)
