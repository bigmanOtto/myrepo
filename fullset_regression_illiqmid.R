...
##illiq_mid~vol_tot
model.1 <- lm(illiq_mid ~ vol_tot, data=subdata1)
...
model.4_sub <- lm(illiq_mid ~ spread1+vol_tot, data=subdata1)
...
model.5_sub <- lm(illiq_mid ~ spread1+log(vol_tot), data=subdata1)
...
model.6_sub <- lm(illiq_mid ~ spread1+sqrt(vol_tot), data=subdata1)
...
model.10 <- lm(illiq_mid ~ spread1+sqrt(vol_tot)+log(trades), data=data)

model.10_sub <- lm(illiq_mid ~ spread1+sqrt(vol_tot)+log(trades), data=subdata1)
...
model.11 <- lm(illiq_mid ~ spread1+log(vol_tot)+trades, data=data)

model.11_sub <- lm(illiq_mid ~ spread1+log(vol_tot)+trades, data=subdata1)
...
model.12 <- lm(illiq_mid ~ spread1+log(vol_tot)+log(trades), data=data)

model.12_sub <- lm(illiq_mid ~ spread1+log(vol_tot)+log(trades), data=subdata1)
...
model.13 <- lm(illiq_mid ~ spread1+sqrt(vol_tot), data=data)

model.13_sub <- lm(illiq_mid ~ spread1+sqrt(vol_tot), data=subdata1)
